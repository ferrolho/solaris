...
- [x] Minimap — schematic top-down orthographic view in a corner, with exaggerated planet sizes, orbital rings, and a camera position indicator ("you are here"). Rendered as a 2D canvas overlay.
